...
const PayButtonCard = ({possible, handleClick,handleChange}) => {
  return (
    <GradientBox 
        ...
        <div >
          ...
          <div style={{width :'100%', display:'flex', justifyContent:'center'}}>
            ...
            <Link to={possible ? '/complete' : '#'} className={possible ? '' : 'disabled'}>
              ...
              <BigButton handleClick={handleClick} title={'결제하기'} backgroundColor='#1976D2' color='white' possible={possible} />        
            </Link>
          </div>
