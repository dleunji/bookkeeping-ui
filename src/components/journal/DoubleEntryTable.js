...
const DoubleEntryTable = ({ journal, onChangePage, totalPages, handleDeleteJournal }) => {
  ...
  return (
    <TableBlock>
          ...
          <TableHead>
            ...
            <TableRow>
              {upperColumns.map((column, idx) => (
                <TableCell align='center' key={idx} colSpan={idx === 2 || idx === 3 ? 2 : 1}>
                  {column}
                </TableCell>
              ))}
            </TableRow>
          ...
          <TableBody>
            {journal?.map((j, idx) => (
              <TableRow key={idx} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                <TableCell align='center'>{j.transactedAt.substr(0, 10)}</TableCell>
                          ...
                          (e.categoryId > 4000 ||
                            ...
                            <TableRow key={idx}>
                              ...
                              >
                                ...
                                {e.sign === -1 ? (
                                  <FontAwesomeIcon className='minus' icon={faArrowDown} />
                                ) : e.sign === 1 ? (
                                  <FontAwesomeIcon className='plus' icon={faArrowUp} />
                                ) : (
                                  ''
                                )}
                              </TableCell>
                ...
                <TableCell align='center'>{j.note}</TableCell>
            ...
            <TableRow>
              ...
              <TableCell align='center'>{debitorTotalAmount.toLocaleString()}</TableCell>
              <TableCell align='center'>합계</TableCell>
              <TableCell align='center'>{creditorTotalAmount.toLocaleString()}</TableCell>
              <TableCell></TableCell>
              <TableCell></TableCell>
            </TableRow>
          </TableBody>
      ...
      <div className='pagination'>
        <Pagination count={totalPages} color='primary' onChange={onChangePage} />
      </div>
    </TableBlock>
  );
};
